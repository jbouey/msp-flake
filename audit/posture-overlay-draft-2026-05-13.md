# POSTURE_OVERLAY.md — Draft v2 for Class-B Gate B (2026-05-13)

> **Target final location:** `docs/POSTURE_OVERLAY.md`
> **Draft status:** v2 for Class-B 7-lens Gate B review. Counsel Priority #3 (Rule 5: no stale document may outrank the current posture overlay). Task #51.
> **Gate A verdict on v1:** APPROVE-WITH-FIXES with 5 P0 findings — all applied in this v2 rewrite.
