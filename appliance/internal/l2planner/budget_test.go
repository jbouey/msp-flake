...
func TestBudgetDefaults(t *testing.T) {
	...
	if stats.DailyBudgetUSD != 5.0 {
		t.Errorf("Expected $5.00 budget, got $%.2f", stats.DailyBudgetUSD)
	}
	if stats.MaxCallsPerHour != 30 {
		t.Errorf("Expected 30 calls/hr, got %d", stats.MaxCallsPerHour)
	}
