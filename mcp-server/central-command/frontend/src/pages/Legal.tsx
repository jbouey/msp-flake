...
const LEGAL_CONTENT: Record<string, { title: string; content: string[] }> = {
  ...
  baa: {
    ...
    content: [
      'OsirisCare executes Business Associate Agreements (BAAs) with all healthcare clients as required by HIPAA.',
      'Architecture Note: OsirisCare\'s platform is designed so that Protected Health Information (PHI) is scrubbed at the appliance level before transmission to central servers. All data is scrubbed of PHI at the appliance level using 14 pattern-matching rules before transmission to our central servers. Our central infrastructure is engineered to be PHI-scrubbed architecture.',
      'Despite this PHI-scrubbed architecture, we execute BAAs as a matter of best practice and to provide our clients with the contractual protections they expect from any vendor operating in healthcare IT.',
