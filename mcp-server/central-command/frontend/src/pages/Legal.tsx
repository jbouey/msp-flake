...
const LEGAL_CONTENT: Record<string, { title: string; content: string[] }> = {
  privacy: {
    ...
    content: [
      ...
      'Information We Collect: We collect infrastructure telemetry data (system configuration state, drift scan results, remediation activity logs) from appliances deployed at your facilities. This data is used to provide compliance monitoring and drift detection services. All data transmitted from appliances is scrubbed of Protected Health Information (PHI) at the appliance level before reaching our servers. Our central infrastructure is designed to be PHI-free.',
  ...
  terms: {
    ...
    content: [
      ...
      'Service Description: OsirisCare provides automated compliance monitoring tools including continuous drift scanning, evidence capture, auto-healing, and compliance reporting for healthcare organizations. The service operates via on-premise appliances that monitor your infrastructure and report to our central management platform.',
