...
export default function SetPassword() {
  ...
  if (validating) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-teal-900 to-slate-900 flex items-center justify-center dark-login">
  ...
  if (!validation?.valid) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-teal-900 to-slate-900 flex items-center justify-center dark-login p-4">
        <GlassCard className="w-full max-w-md text-center py-12">
