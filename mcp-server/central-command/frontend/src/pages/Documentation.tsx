            ...
            <div className="p-4 bg-fill-secondary rounded-ios">
              <ul className="space-y-2 text-sm text-label-secondary">
                <li className="flex items-start gap-2">
                  ...
                  <span>Check if VPS is responding: <code className="bg-background-secondary px-1 rounded">ssh root@178.156.162.116</code></span>
                </li>
                <li className="flex items-start gap-2">
            ...
            <div className="p-4 bg-fill-secondary rounded-ios">
              <ul className="space-y-2 text-sm text-label-secondary">
                <li className="flex items-center gap-2">
                  <input type="checkbox" className="rounded" />
                  <span>API responding: <code className="bg-background-secondary px-1 rounded">curl https://api.osiriscare.net/health</code></span>
                </li>
                <li className="flex items-center gap-2">
                  <input type="checkbox" className="rounded" />
                  <span>Dashboard accessible: <code className="bg-background-secondary px-1 rounded">https://dashboard.osiriscare.net</code></span>
                </li>
                <li className="flex items-center gap-2">
                  <input type="checkbox" className="rounded" />
                  <span>Appliances checking in: <code className="bg-background-secondary px-1 rounded">docker compose logs -f mcp-server | grep checkin</code></span>
                </li>
                <li className="flex items-center gap-2">
                  <input type="checkbox" className="rounded" />
                ...
                <li className="flex items-center gap-2">
                  <input type="checkbox" className="rounded" />
                  <span>Backup timers running: <code className="bg-background-secondary px-1 rounded">systemctl list-timers | grep osiris</code></span>
                </li>
              </ul>
            </div>
        ...
        content: (
          <div className="space-y-6">
            ...
            <div className="p-4 bg-fill-secondary rounded-ios">
              ...
              <div className="p-4 bg-background-secondary rounded-ios text-label-tertiary text-sm font-mono whitespace-pre-wrap">
