        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-separator-light p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center gap-3 mb-3">
              ...
              <p className="text-sm font-medium text-label-tertiary">Issues Detected<InfoTip text="Settings that have drifted from the expected configuration and may need attention." /></p>
            </div>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-label-tertiary">{site.site_id}</p>
                    </div>
                  </div>
