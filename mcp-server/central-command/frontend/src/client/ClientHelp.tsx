...
const EvidenceChainDiagram: React.FC = () => (
  <div className="my-6 p-6 bg-gradient-to-r from-slate-50 to-teal-50 rounded-xl border border-teal-200">
    <h5 className="font-medium text-slate-900 mb-4 text-center">How Evidence Chain Works</h5>
    ...
    <div className="flex items-center justify-center gap-2 overflow-x-auto py-4">
      ...
      <div className="flex-shrink-0 w-32">
        <div className="bg-white rounded-lg border-2 border-teal-500 p-3 shadow-sm">
          <div className="text-xs text-slate-500 mb-1">Check #1</div>
          <div className="text-sm font-medium text-slate-900">Firewall</div>
          <div className="mt-2 font-mono text-xs bg-slate-100 p-1 rounded truncate">
            hash: a3f2...
          </div>
        </div>
        <div className="text-center text-xs text-slate-500 mt-1">9:00 AM</div>
      </div>
      ...
      <div className="flex-shrink-0 w-32">
        <div className="bg-white rounded-lg border-2 border-teal-500 p-3 shadow-sm">
          <div className="text-xs text-slate-500 mb-1">Check #2</div>
          <div className="text-sm font-medium text-slate-900">Backup</div>
          <div className="mt-2 font-mono text-xs bg-slate-100 p-1 rounded truncate">
            prev: a3f2...
          </div>
        </div>
        <div className="text-center text-xs text-slate-500 mt-1">9:05 AM</div>
      </div>
      ...
      <div className="flex-shrink-0 w-32">
        <div className="bg-white rounded-lg border-2 border-teal-500 p-3 shadow-sm">
          <div className="text-xs text-slate-500 mb-1">Check #3</div>
          <div className="text-sm font-medium text-slate-900">Antivirus</div>
          <div className="mt-2 font-mono text-xs bg-slate-100 p-1 rounded truncate">
            prev: b7d4...
          </div>
        </div>
        <div className="text-center text-xs text-slate-500 mt-1">9:10 AM</div>
      </div>

      {/* More indicator */}
      <div className="flex-shrink-0 text-slate-400 text-2xl px-2">...</div>
    </div>
  ...
  <div className="my-6 space-y-4">
    <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
      ...
      <div className="bg-slate-50 border-b border-slate-200 px-4 py-3 flex items-center gap-3">
        <div className="w-8 h-8 bg-teal-100 rounded-lg flex items-center justify-center">
          <OsirisCareLeaf className="w-4 h-4" color="#0d9488" />
        </div>
        <span className="font-medium text-slate-700">Your Practice Name</span>
      </div>
      ...
      <div className="p-4">
        <div className="grid grid-cols-4 gap-3">
          ...
          <div className="bg-slate-50 rounded-lg p-3 relative">
            ...
            <div className="text-xs text-slate-500">Controls Passed</div>
            <div className="text-lg font-bold text-slate-900">12/13</div>
          </div>
          <div className="bg-slate-50 rounded-lg p-3 relative">
    ...
    <div className="grid grid-cols-2 gap-3 text-sm">
      <div className="flex items-start gap-2">
        ...
        <span className="text-slate-600"><strong>Compliance Score</strong> - Your overall HIPAA compliance percentage</span>
      </div>
      <div className="flex items-start gap-2">
        ...
        <span className="text-slate-600"><strong>Controls Passed</strong> - How many checks are passing vs total</span>
      </div>
      <div className="flex items-start gap-2">
        ...
        <span className="text-slate-600"><strong>Issues</strong> - Failed checks requiring attention</span>
      </div>
      <div className="flex items-start gap-2">
        ...
        <span className="text-slate-600"><strong>Sites</strong> - Number of locations being monitored</span>
      </div>
    </div>
  </div>
);
    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-4">
        ...
        <div className="flex-1">
          <h5 className="font-medium text-slate-900">Navigate to Evidence Archive</h5>
          <p className="text-sm text-slate-600 mt-1">Click "Evidence Archive" from the dashboard quick links</p>
          <div className="mt-2 bg-slate-50 rounded-lg p-3 flex items-center gap-3">
            ...
            <div>
              <div className="font-medium text-slate-900 text-sm">Evidence Archive</div>
              <div className="text-xs text-slate-500">View and download compliance evidence</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex gap-4">
        ...
        <div className="flex-1">
          <h5 className="font-medium text-slate-900">Find the Evidence You Need</h5>
          <p className="text-sm text-slate-600 mt-1">Use filters to find specific check types, dates, or HIPAA controls</p>
          <div className="mt-2 bg-slate-50 rounded-lg p-3">
            <div className="flex items-center gap-2 text-sm">
              <span className="px-2 py-1 bg-white border border-slate-200 rounded text-slate-700">All Results</span>
              <span className="text-slate-400">|</span>
              <span className="text-slate-500">97,891 total bundles</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex gap-4">
        ...
        <div className="flex-1">
          <h5 className="font-medium text-slate-900">Download or View Details</h5>
          <p className="text-sm text-slate-600 mt-1">Click the eye icon to view details, or download icon to get the bundle</p>
          <div className="mt-2 bg-slate-50 rounded-lg p-3 flex items-center justify-between">
            <div className="text-sm">
              <div className="text-slate-900">windows_backup_status</div>
              <div className="text-xs text-slate-500">164.312(b) - Audit Controls</div>
            </div>
            <div className="flex items-center gap-2">
              <span className="px-2 py-0.5 bg-green-100 text-green-700 text-xs rounded">Pass</span>
              <button className="p-1.5 hover:bg-teal-50 rounded" title="View" aria-label="View">
              ...
              <button className="p-1.5 hover:bg-teal-50 rounded" title="Download" aria-label="Download">
                <svg className="w-4 h-4 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="space-y-3">
            <div className="bg-white border border-slate-200 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-medium text-slate-900">164.312(a)(1) - Access Control</div>
            ...
            <div className="bg-white border border-slate-200 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-medium text-slate-900">164.312(b) - Audit Controls</div>
                  <div className="text-sm text-slate-600 mt-1">
            ...
            <div className="bg-white border border-slate-200 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-medium text-slate-900">164.312(c)(1) - Integrity</div>
                  <div className="text-sm text-slate-600 mt-1">
            ...
            <div className="bg-white border border-slate-200 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-medium text-slate-900">164.312(d) - Person or Entity Authentication</div>
                  <div className="text-sm text-slate-600 mt-1">
            ...
            <div className="bg-white border border-slate-200 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-medium text-slate-900">164.312(e)(1) - Transmission Security</div>
                  <div className="text-sm text-slate-600 mt-1">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <h5 className="font-medium text-slate-900">User Roles</h5>
          <div className="space-y-2">
            <div className="flex items-start gap-3 p-3 bg-purple-50 rounded-lg">
              <span className="bg-purple-200 text-purple-800 px-2 py-1 rounded text-sm font-medium">Owner</span>
              <span className="text-slate-700 text-sm">Full access including billing, user management, and provider transfer requests</span>
            </div>
            <div className="flex items-start gap-3 p-3 bg-blue-50 rounded-lg">
              <span className="bg-blue-200 text-blue-800 px-2 py-1 rounded text-sm font-medium">Admin</span>
              <span className="text-slate-700 text-sm">Manage users, view all data, download evidence - everything except billing</span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white border border-slate-200 rounded-lg p-4">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h5 className="font-medium text-slate-900">Technical Issues</h5>
              </div>
              <p className="text-slate-600 text-sm">
            ...
            <div className="bg-white border border-slate-200 rounded-lg p-4">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h5 className="font-medium text-slate-900">Portal Support</h5>
              </div>
              <p className="text-slate-600 text-sm">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 mb-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-slate-600">Find answers to common questions about your compliance portal</p>
            </div>
          </div>
        </div>
