        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14">
            <div className="flex items-center gap-4">
              <Link to="/client/settings" className="p-2 text-slate-500 hover:text-teal-600 rounded-lg hover:bg-teal-50">
              ...
              {totpEnabled ? (
                ...
                <div>
                  ...
                  <button
                    ...
                    style={{ background: 'linear-gradient(135deg, #14A89E 0%, #3CBCB4 100%)', boxShadow: '0 2px 10px rgba(20,168,158,0.3)' }}
                  >
                    Enable 2FA
                  </button>
                </div>
            ...
            <form onSubmit={handleVerify} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="000000"
                  className="w-full px-4 py-2.5 bg-slate-50/80 border border-slate-200 rounded-xl text-center text-lg font-mono tracking-[0.5em] focus:ring-2 focus:ring-teal-500/40 focus:border-teal-300 outline-none transition"
                  required
                  autoFocus
                />
              </div>
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-slate-50/80 border border-slate-200 rounded-xl focus:ring-2 focus:ring-teal-500/40 focus:border-teal-300 outline-none transition"
                  required
                />
              </div>
