      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm mb-4 p-5 flex items-start justify-between">
          ...
          <div className="text-right">
            {(() => {
              // Runbook-consent class coverage (75/25 thresholds) is a
              // domain-distinct metric — fraction of HIPAA-control classes
              // with active operator-consent. Lower-bar than compliance
              // score because partial-consent during rollout is normal.
              const coverageColor = data.coverage_pct >= 75 ? 'text-emerald-600' : data.coverage_pct >= 25 ? 'text-amber-600' : 'text-rose-600';  // noqa: score-threshold-gate — consent-coverage domain (75/25)
              return (
                <div className={`text-3xl font-bold tabular-nums ${coverageColor}`}>
