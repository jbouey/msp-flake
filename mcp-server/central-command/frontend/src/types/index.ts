...
export const CHECK_TYPE_LABELS: Record<string, string> = {
  ...
  bitlocker: 'BitLocker',
  screen_lock: 'Screen Lock',
  // macOS checks (Go daemon scanner)
  macos_filevault: 'FileVault',
  macos_gatekeeper: 'Gatekeeper',
  macos_sip: 'SIP',
  macos_firewall: 'macOS FW',
  macos_auto_update: 'macOS Updates',
  macos_screen_lock: 'macOS Lock',
  macos_remote_login: 'Remote Login',
  macos_file_sharing: 'File Sharing',
  macos_time_machine: 'Time Machine',
  macos_ntp_sync: 'macOS NTP',
  macos_admin_users: 'macOS Admins',
  macos_disk_space: 'macOS Disk',
